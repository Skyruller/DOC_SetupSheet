...
namespace SetupSheet
{
    ...
    {
        public override string PluginName { get { return "DOC SetupSheet"; } }
        public override string PluginAuthor { get { return "Autodesk"; } }
        public override string PluginDescription { get { return "Export NC and tool list to DOC"; } }
        ...
        public override Version PowerMILLVersion { get { return new Version(0, 0); } }
        ...
        protected override void register_panes()
        {
            ...
            register_pane(new PaneDefinition(oToolSheetPaneWPF, 800, 300, "DOC SetupSheet", "Icons/Icon_24.ico"));
        }
